            ...
            Drawing.OnDraw += delegate
                              {
                                      ...
                                      Vars.Menu["drawings"]["e"].GetValue<MenuBool>().Value)
                                  {
                                              ...
                                              GameObjects.EnemyHeroes.Where(t => t.IsValidTarget(Vars.E.Range)))
                                      {
                                          ...
                                          ///     The Position Line.
                                          /// </summary>
                                          Drawing.DrawLine(Drawing.WorldToScreen(ObjectManager.Player.Position).X,
                                                           ...
                                                           (target.Position +
                                                            Vector3.Normalize(target.Position -
                                                                              ObjectManager.Player.Position)*420)
                                                               .IsWall()
                                                               ? Color.Green
                                                               : Color.Red);
                                          ...
                                          Drawing.DrawLine(
                                              ...
                                              Drawing.WorldToScreen(target.Position +
                                                                    Vector3.Normalize(target.Position -
                                                                                      ObjectManager.Player.Position)*440)
                                                     .X,
                                              Drawing.WorldToScreen(target.Position +
                                                                    Vector3.Normalize(target.Position -
                                                                                      ObjectManager.Player.Position)*440)
                                          ...
                                          Drawing.DrawLine(Drawing.WorldToScreen(ObjectManager.Player.Position).X,
                                                           ...
                                                           (Vars.E.GetPrediction(target).UnitPosition +
                                                            Vector3.Normalize(target.Position -
                                                                              ObjectManager.Player.Position)*420).IsWall
                                                               ()
                                                               ? Color.Green
                                                               : Color.Red);
