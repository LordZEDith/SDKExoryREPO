                                      ...
                                      GameObjects.Heroes.Where(
                                          e =>
                                              ...
                                              (e.IsMe && Vars.Menu["spelltracker"]["me"].GetValue<MenuBool>().Value ||
                                               e.IsEnemy &&
                                               Vars.Menu["spelltracker"]["enemies"].GetValue<MenuBool>().Value ||
                                               e.IsAlly && !e.IsMe &&
                                               Vars.Menu["spelltracker"]["allies"].GetValue<MenuBool>().Value)))
                                  {
                                      for (var Spell = 0;
                                           Spell < Vars.SpellSlots.Length;
                                           Spell++)
                                      {
                                          Vars.SpellX = (int) unit.HPBarPosition.X + Vars.SpellXAdjustment(unit) +
                                                        Spell*25;
                                          Vars.SpellY = (int) unit.HPBarPosition.Y + Vars.SpellYAdjustment(unit);
                                          Vars.DisplayTextFont.DrawText(null,
                                                                        unit.Spellbook.GetSpell(Vars.SpellSlots[Spell])
                                                                            .CooldownExpires - Game.Time > 0
                                                                        ...
                                                                        unit.Spellbook.GetSpell(Vars.SpellSlots[Spell])
                                                                            ...
                                                                            : unit.Spellbook.GetSpell(
                                                                                Vars.SpellSlots[Spell])
                                                                                  .SData.ManaCostArray.MaxOrDefault(
                                                                                      value => value) > unit.Mana
                                      ...
                                      for (var SummonerSpell = 0;
                                           SummonerSpell < Vars.SummonerSpellSlots.Length;
                                           SummonerSpell++)
                                      {
                                          Vars.SummonerSpellX = (int) unit.HPBarPosition.X +
                                                                Vars.SummonerSpellXAdjustment(unit) +
                                                                SummonerSpell*88;
                                          Vars.SummonerSpellY = (int) unit.HPBarPosition.Y +
                                                                Vars.SummonerSpellYAdjustment(unit);
                                          switch (
                                              unit.Spellbook.GetSpell(Vars.SummonerSpellSlots[SummonerSpell])
                                                  .Name.ToLower())
                                          {
                                              case "summonerflash":
                                          ...
                                          Vars.DisplayTextFont.DrawText(null,
                                                                        unit.Spellbook.GetSpell(
                                                                            Vars.SummonerSpellSlots[SummonerSpell])
                                                                            .CooldownExpires - Game.Time >
                                                                        0
