            ...
            Drawing.OnDraw += delegate
                              {
                                  ...
                                  foreach (var unit in
                                      GameObjects.Heroes.Where(
                                                               e =>
                                                                   e.IsHPBarRendered
                                                                       && (e.IsMe && Vars.Menu["spelltracker"]["me"].GetValue<MenuBool>()
                                                                                                                    .Value
                                                                           || e.IsEnemy && Vars.Menu["spelltracker"]["enemies"].GetValue<MenuBool>()
                                                                                                                               .Value
                                                                           || e.IsAlly && !e.IsMe
                                                                               && Vars.Menu["spelltracker"]["allies"].GetValue<MenuBool>()
                                                                                                                     .Value)))
                                  {
                                      for (var Spell = 0;
                                           ...
                                           Spell++)
                                      {
                                          ...
                                          Vars.DisplayTextFont.DrawText(null,
                                              ...
                                              unit.Spellbook.GetSpell(Vars.SpellSlots[Spell])
                                                  ...
                                                  : unit.Spellbook.GetSpell(Vars.SpellSlots[Spell])
                                                      ...
                                                      : unit.Spellbook.GetSpell(Vars.SpellSlots[Spell])
                                                            .CooldownExpires - Game.Time > 0 && unit.Spellbook.GetSpell(Vars.SpellSlots[Spell])
                                          ...
                                          for (var level = 0;
                                               level <= unit.Spellbook.GetSpell(Vars.SpellSlots[Spell])
                                                            .Level - 1;
                                               level++)
                                          {
                                           ...
                                           SummonerSpell++)
                                      {
                                          ...
                                          switch (unit.Spellbook.GetSpell(Vars.SummonerSpellSlots[SummonerSpell])
                                                      .Name.ToLower())
                                          {
                                              case "summonerflash":
