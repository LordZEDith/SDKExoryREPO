        ...
        public static void Initialize()
        {
            ...
            Drawing.OnDraw += delegate
            {
                ...
                if (Vars.Q != null && Vars.Q.IsReady())
                {
                    ...
                    if (Vars.Menu["drawings"]["qe"] != null && Vars.Menu["drawings"]["qe"].GetValue<MenuBool>().Value)
                    {
                ...
                if (Vars.R != null && Vars.R.IsReady())
                {
                    ...
                    if (Vars.Menu["drawings"]["r2"] != null && Vars.Menu["drawings"]["r2"].GetValue<MenuBool>().Value)
                    {
