...
namespace ExorAIO.Champions.Amumu
{
    ...
    internal partial class Logics
    {
        ...
        public static void Combo(EventArgs args)
        {
            ...
            ///     The Q Combo Logic.
            /// </summary>
            if (Vars.Q.IsReady() && !Targets.Target.IsValidTarget(Vars.E.Range) && Targets.Target.IsValidTarget(Vars.Q.Range - 100f) &&
            ...
            ///     The E Combo Logic.
            /// </summary>
            if (Vars.E.IsReady() && Targets.Target.IsValidTarget(Vars.E.Range - 25f) && Vars.Menu["spells"]["e"]["combo"].GetValue<MenuBool>()
                                                                                                                         .Value)
            {
                Vars.E.Cast();
            }
            ...
            /// </summary>
            if (Vars.R.IsReady() &&
                GameObjects.Player.CountEnemyHeroesInRange(Vars.R.Range - 50f) >= Vars.Menu["spells"]["r"]["combo"].GetValue<MenuSliderButton>()
                                                                                                                   .SValue
