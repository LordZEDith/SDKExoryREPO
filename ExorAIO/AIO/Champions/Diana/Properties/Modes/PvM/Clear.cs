    ...
    internal partial class Logics
    {
        ...
        public static void Clear(EventArgs args)
        {
            ...
            if (Vars.Q.IsReady())
            {
                ...
                if (Targets.Minions.Any() &&
                    ...
                    Vars.Menu["spells"]["q"]["laneclear"].GetValue<MenuSliderButton>()
                                                         .BValue && Vars.Q.GetLineFarmLocation(Targets.Minions, Vars.Q.Width)
                                                                        .MinionsHit >= 3)
                {
            ...
            if (Vars.R.IsReady() && Targets.JungleMinions.Any(m => m.HasBuff("dianamoonlight")) &&
                GameObjects.Player.ManaPercent > ManaManager.GetNeededMana(Vars.R.Slot, Vars.Menu["spells"]["r"]["jungleclear"]) &&
                Vars.Menu["spells"]["r"]["jungleclear"].GetValue<MenuSliderButton>()
                                                       .BValue)
            {
