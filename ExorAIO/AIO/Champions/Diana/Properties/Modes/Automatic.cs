...
namespace ExorAIO.Champions.Diana
{
    ...
    internal partial class Logics
    {
        ...
        public static void Automatic(EventArgs args)
        {
            ...
            /// </summary>
            if (Vars.Menu["spells"]["r"]["bool"].GetValue<MenuBool>()
            ...
            /// </summary>
            if (Vars.R.IsReady() && Vars.Q.IsReady() && GameObjects.Player.Mana > Vars.R.Instance.ManaCost + Vars.Q.Instance.ManaCost &&
                Targets.Target.IsValidTarget(Vars.R2.Range) && Vars.Menu["spells"]["r"]["bool"].GetValue<MenuBool>()
                                                                                               .Value
            ...
            /// </summary>
            if (Vars.E.IsReady() &&
                GameObjects.Player.CountEnemyHeroesInRange(Vars.E.Range) >= Vars.Menu["spells"]["e"]["aoe"].GetValue<MenuSliderButton>()
                                                                                                           .SValue
