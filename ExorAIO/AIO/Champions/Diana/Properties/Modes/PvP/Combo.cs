    ...
    internal partial class Logics
    {
        ...
        public static void Combo(EventArgs args)
        {
            ...
            if (Vars.R.IsReady())
            {
                ...
                ///     The R Combo Logics.
                /// </summary>
                if (Targets.Target.IsValidTarget(Vars.R.Range) && Vars.Menu["spells"]["r"]["combo"].GetValue<MenuBool>()
                                                                                                   .Value)
                {
                    /// <summary>
                                                                                                    ...
                                                                                                    .Value)
                    {
                        if (!Targets.Target.IsUnderEnemyTurret() ||
                            ...
                            !Vars.Menu["miscellaneous"]["safe"].GetValue<MenuBool>()
                                                               .Value)
                        {
                    ...
                    /// </summary>
                    if (!Vars.Q.IsReady() && !Targets.Target.HasBuff("dianamoonlight") && Vars.Menu["miscellaneous"]["rcombo"].GetValue<MenuBool>()
                                                                                                                              .Value
                        && Vars.Menu["spells"]["r"]["whitelist"][Targets.Target.ChampionName.ToLower()].GetValue<MenuBool>()
                                                                                                       .Value)
                    {
                ...
                /// </summary>
                else if (Targets.Target.IsValidTarget(Vars.Q.Range * 2) && !Targets.Target.IsValidTarget(Vars.Q.Range + 200) &&
                    Vars.Menu["miscellaneous"]["gapclose"].GetValue<MenuBool>()
                                                          .Value)
                {
                    if (
                        Targets.Minions.Any(
            ...
            /// </summary>
            if (Vars.E.IsReady() && !Targets.Target.IsValidTarget(Vars.AARange) && Targets.Target.IsValidTarget(Vars.E.Range - 25) &&
