...
namespace ExorAIO.Champions.Taliyah
{
    ...
    internal partial class Logics
    {
        ...
        public static void Combo(EventArgs args)
        {
            ...
            {
                Vars.E.Cast(Targets.Target.IsFacing(GameObjects.Player) &&
                    GameObjects.Player.Distance(Targets.Target) < Vars.AARange/2
                        ? Targets.Target.ServerPosition
                        : Targets.Target.ServerPosition.Extend(GameObjects.Player.ServerPosition, -Targets.Target.Distance(GameObjects.Player)/2));
            }
