            ...
            Vars.SpellsMenu = new Menu("spells", "Spells");
            {
                ...
                Vars.RMenu = new Menu("r", "Use R to:");
                {
                    ...
                    Vars.RMenu.Add(new MenuSeparator("separator2",
                                                     "Keep the button pressed until you want to stop the ultimate."));
