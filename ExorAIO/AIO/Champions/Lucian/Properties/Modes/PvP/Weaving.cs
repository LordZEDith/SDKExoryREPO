...
namespace ExorAIO.Champions.Lucian
{
    ...
    internal partial class Logics
    {
        ...
        public static void Weaving(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            ///     The E Combo Logic.
            /// </summary>
            if (Vars.E.IsReady() && Vars.Menu["spells"]["e"]["mode"].GetValue<MenuList>()
                                                                    .Index != 2)
            {
                if (!Game.CursorPos.IsUnderEnemyTurret() ||
                    ((Obj_AI_Hero)args.Target).Health < GameObjects.Player.GetAutoAttackDamage((Obj_AI_Hero)args.Target) * 2)
                {
                    switch (Vars.Menu["spells"]["e"]["mode"].GetValue<MenuList>()
                                                            .Index)
                    {
                        case 0:
            ...
            ///     The Q Combo Logic.
            /// </summary>
            if (Vars.Q.IsReady() && ((Obj_AI_Hero)args.Target).IsValidTarget(Vars.Q.Range) && Vars.Menu["spells"]["q"]["combo"].GetValue<MenuBool>()
                                                                                                                               .Value)
            {
            ...
            ///     The W Combo Logic.
            /// </summary>
            if (Vars.W.IsReady() && ((Obj_AI_Hero)args.Target).IsValidTarget(Vars.W.Range) && Vars.Menu["spells"]["w"]["combo"].GetValue<MenuBool>()
                                                                                                                               .Value)
            {
