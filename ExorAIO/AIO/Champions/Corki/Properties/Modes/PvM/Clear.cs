    ...
    internal partial class Logics
    {
        ...
        public static void Clear(EventArgs args)
        {
                                                 ...
                                                 .BValue)
            {
                ...
                /// </summary>
                if (Vars.Q.GetCircularFarmLocation(Targets.Minions, Vars.Q.Width)
                        .MinionsHit >= 3)
                {
            ...
            ///     The Clear R Logics.
            /// </summary>
            if (Vars.R.IsReady() && GameObjects.Player.ManaPercent > ManaManager.GetNeededMana(Vars.R.Slot, Vars.Menu["spells"]["r"]["clear"]) &&
                                                 ...
                                                 .BValue)
            {
                ...
                /// </summary>
                if (Vars.R.GetLineFarmLocation(Targets.Minions, Vars.R.Width)
                        .MinionsHit >= 2)
                {
                    Vars.R.Cast(Vars.R.GetLineFarmLocation(Targets.Minions, Vars.R.Width)
                                    .Position);
                }
