...
namespace ExorAIO.Champions.Vayne
{
    ...
    internal partial class Logics
    {
        ...
        public static void Automatic(EventArgs args)
        {
            ...
            /// </summary>
            if (Vars.E.IsReady() && !GameObjects.Player.IsDashing() && Vars.Menu["spells"]["e"]["logical"].GetValue<MenuBool>()
                                                                                                          .Value)
            {
                         ...
                         i++)
                    {
                        ...
                        if ((target.ServerPosition + vector * (float)(i * 42.5)).IsWall() && (Vars.E.GetPrediction(target)
                            ...
                            && (Vars.E2.GetPrediction(target)
                                    .UnitPosition + vector * (float)(i * 42.5)).IsWall() &&
                            (target.ServerPosition + vector * (float)(i * 44.5)).IsWall() && (Vars.E.GetPrediction(target)
