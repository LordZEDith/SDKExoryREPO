...
namespace ExorAIO.Champions.Udyr
{
    ...
    internal partial class Logics
    {
        ...
        public static void Clear(EventArgs args)
        {
            ...
            ///     The W Clear Logic.
            /// </summary>
            if (Vars.W.IsReady() && GameObjects.Player.HealthPercent < Vars.Menu["spells"]["w"]["clear"].GetValue<MenuSliderButton>()
                                                                                                        .SValue
            ...
            if (Targets.JungleMinions.Any())
            {
                ...
                /// </summary>
                if (Vars.E.IsReady() &&
                    GameObjects.Player.ManaPercent >= ManaManager.GetNeededHealth(Vars.E.Slot, Vars.Menu["spells"]["e"]["jungleclear"]) &&
                    Vars.Menu["spells"]["e"]["jungleclear"].GetValue<MenuSliderButton>()
                                                           .BValue)
                {
                    var objAiMinion = Variables.Orbwalker.GetTarget() as Obj_AI_Minion;
                    if (objAiMinion != null && objAiMinion.IsValidTarget(Vars.R.Range) && !objAiMinion.HasBuff("udyrbearstuncheck"))
                    {
                        Vars.E.Cast();
                    }
                }
                                                                                     ...
                                                                                     .Level == 0)
                {
                    ...
                    if (Vars.R.IsReady() && GameObjects.Player.GetBuffCount("UdyrPhoenixStance") != 3 &&
                        GameObjects.Player.ManaPercent >= ManaManager.GetNeededHealth(Vars.R.Slot, Vars.Menu["spells"]["r"]["clear"]) &&
                ...
                else
                {
                    ...
                    /// </summary>
                    if (Vars.Q.IsReady() &&
                        GameObjects.Player.ManaPercent >= ManaManager.GetNeededHealth(Vars.Q.Slot, Vars.Menu["spells"]["q"]["clear"]) &&
        ...
        public static void BuildingClear(EventArgs args)
        {
            ...
            /// </summary>
            if (Vars.Q.IsReady() && GameObjects.Player.ManaPercent > ManaManager.GetNeededHealth(Vars.Q.Slot, Vars.Menu["spells"]["q"]["buildings"])
                &&
